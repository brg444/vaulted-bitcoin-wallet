...
for fixture in fixtures:
    if os.environ.get('CANDIDATE_TIER') and fixture['id']!=os.environ['CANDIDATE_TIER']: continue
    name=fixture['id']
...
(root/('ledger-recovery-'+os.environ.get('CANDIDATE_TIER','all')+'.json')).write_text(json.dumps(rows,indent=2)+'\n')
