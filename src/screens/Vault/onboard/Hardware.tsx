...
export default function VaultHardware() {
  ...
  return (
    ...
    >
      ...
      <p className='qg-copy'>Import your signing wallet’s public descriptor to approve Savings transfers.</p>
      ...
      <details className='qg-guidance'>
        <summary>Signer compatibility and setup</summary>
        <div className='qg-guidance-body'>
          <details className='qg-guidance'>
            <summary>Compatible signing options</summary>
            <div className='qg-guidance-body'>
              <p>
                Sparrow 2.5.4 software signing and Bitcoin Core 31.0 RPC signing passed automated tests for native
                SegWit and Taproot. Hardware key protection requires a separate physical signing device.
              </p>
              <p>
                Ledger Bitcoin app 2.4.2 passed simulator tests. Physical Ledger approval and funded production tests
                remain incomplete. Jade is not compatible with this Savings signing flow; other hardware devices and
                Electrum have not been qualified for it.
              </p>
              <p>
                Sparrow and Ledger may show a non-default signature warning. Review the recipient and amount carefully;
                the two reserve signatures approve the recipient and protected change separately. Return the signed PSBT
                to Vaulted to complete the transfer.
              </p>
            </div>
          </details>
          <details className='qg-guidance'>
            ...
            <div className='qg-guidance-body'>
              ...
              <p>
                For software testing, choose New or Imported Software Wallet and create a BIP39 seed, or import a
                dedicated test seed. Use a new wallet for test keys and keep them separate from your savings.
              </p>
              <p>
                Native SegWit (BIP84) is also supported. Keep the wallet type and descriptor matched: tr for Taproot,
                wpkh for native SegWit. Choose a tested signing setup before funding Savings.
              </p>
            </div>
          </details>
          <details className='qg-guidance'>
            ...
            <div className='qg-guidance-body'>
              ...
              <p>
                The tested Ledger simulator showed external-input and non-default signature warnings. Savings is an
                external input; Ledger signs the two reserve inputs. Review the recipient, any Savings change, both
                500-sat reserve returns, the 240-sat anchor and the fee on the device.
              </p>
              <p>
              ...
              <p>
                Return the partially signed PSBT to Vaulted, then complete the remaining approvals there. The desktop
                wallet may show only the reserve balance; use Vaulted to manage Savings and leave its reserve outputs
          ...
          <details className='qg-guidance'>
            ...
            <div className='qg-guidance-body'>
              <p>
                In your wallet, look for an export option called Output Descriptor or Wallet Descriptor. Show its QR
                code or export a text file containing a public tr or wpkh descriptor with the key fingerprint and
                derivation path.
              </p>
              <p>
              ...
              <p>
                Before depositing, confirm that your signing workflow supports Vaulted’s Savings transactions. Accepting
                a descriptor here checks its format, not whether your signer can sign.
              </p>
            </div>
          </details>
        </div>
      ...
      <section className='qg-note'>
        <TriangleAlert />
        <div>
          <strong>Check signer compatibility</strong>
          <p>Use a tested signer before depositing. Never enter seed words or private keys.</p>
        </div>
      </section>
    </QgScreen>
  )
